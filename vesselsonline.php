...
?>
    ...
    <div class="viewPorts">
      <script type="text/javascript">
        ...
        latitude = '-38.4460';	// the latitude of the center of the map, in decimal degrees 
        longitude = '-58.9467';	// the longitude of the center of the map, in decimal degrees 
        zoom = '2';	// the zoom level of the map (values between 2 and 17) 
    ...
    <div class="petroCartelPuertos" style="opacity: 0.5;"><img src="http://www.petromarina.net/img/petroW02.png"
        width="280px" alt=""></div>

    <div class="tapon">
      <img src="img/petroW01.png" width="180px" height="27px" alt="" />
    </div>
    <div class="taponLeft">
      ...
      <div class="footer-social-links">
        <div class="social-links tooltip-bot">
          ...
          <a href="https://instagram.com/petromarinainc?igshid=p2al93lbszo0" title="Instagram" target="_blank"><i
              class="fa fa-instagram" style="color: white;"></i></a></br></br>
          <a href="javascript:void(0);" title="Facebook" target="_blank"><i class="fa fa-facebook"
              style="color: white;"></i></a></br></br>
          <a href="https://twitter.com/PETROMARINA2?s=08" title="Twitter" target="_blank"><i class="fa fa-twitter"
              style="color: white;"></i></a></br></br>
          <a href="javascript:void(0);" title="Google+" target="_blank"><i class="fa fa-google-plus"
              style="color: white;"></i></a></br></br>
          <a href="https://www.linkedin.com/posts/activity-6582576446919835648-0LH6" title="LinkedIn+"
            target="_blank"><i class="fa fa-linkedin" style="color: white;"></i></a></br></br>
          <a href="javascript:void(0);" title="Pinterest" target="_blank"><i class="fa fa-pinterest"
              style="color: white;"></i></a></br></br>
          <a href="mailto:shipchandler@petromarina.net" title="E-mail" target="_blank"><i class="fa fa-envelope"
